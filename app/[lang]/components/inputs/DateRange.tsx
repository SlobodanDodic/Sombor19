...
export function DateRange({ value, placeholder }: IDateRange) {
  ...
  return (
    <DatePicker
      ...
      format="dd-MMM-YYYY"
      inputClass="flex w-[200px] h-7 bg-amber-600 text-sm capitalize text-center font-normal items-center rounded border-0 text-white ring-2 sm:mr-2 mb-2 sm:mb-0 ring-white/70 placeholder:text-white hover:cursor-pointer"
      value={placeValue}
