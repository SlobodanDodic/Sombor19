...
export function GuestsSelect({ defaultValue, guests }: GuestsSelectProps) {
  ...
  return (
    <select
      id="guests"
      className="flex w-[200px] h-7 sm:w-[100px] bg-amber-600 text-center items-center rounded border-0 text-white/90 ring-2 ring-white/70 placeholder:text-white/90"
