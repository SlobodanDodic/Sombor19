  ...
  return (
    <main className="flex flex-col items-center justify-between">
      <div className="relative flex w-screen max-w-full">
        ...
        {/* <div className="absolute top-16 right-32 w-24 h-96 backdrop-invert hover:backdrop-invert-0 transition-all" /> */}
        ...
        <div className="flex flex-col items-center w-screen max-w-full py-12 px-2">
          ...
          <div className="flex w-full sm:max-w-xl px-2 sm:px-7 mt-20 justify-center">
            <div className="flex p-3 border uppercase bg-black/30 border-amber-600 font-bold text-lg w-fit my-8 text-amber-600 rounded">
              {page.home.visit}
            </div>
          </div>
        </div>
